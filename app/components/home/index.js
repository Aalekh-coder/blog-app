...
// export default function HomeComponents({ posts }) {
//   const [isGridViews, setIsGridView] = useState(false);
...
//             variant="ghost"
//             size="icon"
//             className={!isGridViews ? "bg-gray-100" : ""}
//           >
...
//                       <div className={`flex-1 p-4 ${isGridViews? "" : "w-2/3" }`}>
...
//                               </AvatarFallback>
//                           </Avatar>
//                           <span className="text-[16px] font-medium text-gray-700">{postItem?.author?.name}</span>
//                       <h3 className="text-xl font-bold mb-2 text-gray-800 line-clamp-2">{postItem?.title}</h3>
